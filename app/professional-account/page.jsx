...
import ProfrssionalAccount from '@/typewriterC/ProfessionalWriter';
const page = () => {
  return (
    <div className='professional-account'>
       <div className="professional-account-hero">
        <ProfrssionalAccount/>
       </div>
       <div className="standard-table md:w-[60%] my-20 mx-auto">
        ...
        <div>
            <h2 className='text-center mt-10 text-xl bg-[#2b61ac] p-3 text-gray-100 font-bold'>Professional Account</h2>
            <div className='stabdard-parent'>
                <div className='standard-ac flex justify-between  border border-1  border-b-0 border-gray-300  '>
                    ...
                    <h2 className='pr-10 my-4'>50,000 USD</h2>
                </div>
                   <div className='standard-ac flex justify-between  border border-1 border-b-0 border-gray-300   '>
                    <h2 className='pl-10 my-4 font-bold text-md'>Spreads From</h2>
                    <h2 className='pr-10 my-4'>0.5 Pips</h2>
                </div>
                  <div className='standard-ac flex justify-between  border border-1 border-b-0 border-gray-300   '>
