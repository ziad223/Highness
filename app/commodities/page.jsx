...
import CommoditiesWriter from '../../typewriterC/CommoditiesWriter';
const page = () => {
  return (
  ...
  <div className="overflow-x-auto sm:-mx-6 lg:-mx-8">
    <div className="inline-block min-w-full py-2 sm:px-6 lg:px-8">
     ...
     <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64  my-20'>
      ...
      <h4 className='text-gray-500 text-lg mt-2'>Here are our most frequently asked questions about trading commodities with Highness Investment LLC.
</h4>
      </div>
